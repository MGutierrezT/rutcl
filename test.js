...
test('getDigit', t => {
    t.is(getDigit('20.288.020-7'), '7')
    t.is(getDigit('20288020-7'), '7')
    t.is(getDigit('202880207'), '7')
    t.is(getDigit('19.670.978-9'), '9')
    t.is(getDigit('19670978-9'), '9')
    t.is(getDigit('196709789'), '9')
    t.is(getDigit('20.129.969-1'), '1')
    t.is(getDigit('20129969-1'), '1')
    t.is(getDigit('201299691'), '1')
})
